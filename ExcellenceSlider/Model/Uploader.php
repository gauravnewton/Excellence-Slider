...
class Uploader
{
     ...
     * @var string
     */
    const IMAGE_TMP_PATH    = 'excellenceslider/tmp/images/image_path';
    /**
     * @var string
     */
    const IMAGE_PATH        = 'excellenceslider/images/image_path';
    /**
     * @var string
     */
    const FILE_TMP_PATH     = 'excellenceslider/tmp/images/file';
    /**
     * @var string
     */
    const FILE_PATH         = 'excellenceslider/images/file';
